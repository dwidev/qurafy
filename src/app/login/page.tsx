        ...
        <div className="min-h-screen flex items-center justify-center bg-background p-6">
            <div className="w-full max-w-[360px] space-y-7">
                ...
                <div className="space-y-4">
                    <button className="w-full flex items-center justify-center gap-2.5 h-11 rounded-xl border border-border bg-card hover:bg-muted transition-all text-xs font-black">
                    ...
                    <div className="relative">
                        ...
                        <div className="relative flex justify-center text-[9px] font-black uppercase tracking-widest text-muted-foreground/60">
                ...
                <form onSubmit={handleSubmit} className="space-y-3">
                        ...
                        {mode === "register" && (
                            <div className="space-y-1">
                                <input
                                    ...
                                    className="w-full h-10 bg-secondary/30 border border-border rounded-lg px-3.5 text-xs font-bold focus:outline-hidden focus:border-primary/50 focus:bg-card transition-all placeholder:text-muted-foreground/50"
                                    required
                                />
                            </div>
                        )}
                    ...
                    <div className="flex justify-end pt-1">
                        <Link href="#" className="text-[10px] font-bold text-primary hover:underline underline-offset-4">
                            Forgot password?
                        </Link>
                    </div>
